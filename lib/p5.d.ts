...
declare class p5 {
  ...
  fill(value: number, alpha?: number): p5;
  ...
  stroke(shade: number, alpha?: number): p5;
...
declare namespace p5 {
  ...
  class RendererGL extends p5.Renderer {
     ...
     */
    constructor(
      v1: number | number[] | string | p5.Color,
      v2?: number,
      v3?: number,
      a?: number
    );
  ...
  class Texture {
    ...
    constructor(
      ...
      obj?: p5.Image | p5.Graphics | p5.Element | p5.MediaElement
    );
