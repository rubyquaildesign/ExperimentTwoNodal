 ...
 */
function getC(name: string): colourObj;
 ...
 * @return colour object, get hex string with hex property
 */
function getC(hue: string, shad: number): colourObj;
/**
 ...
 * @return colour object, get hex string with hex property
 */
function getC(hue: number, shad: number): colourObj;
/**
 ...
 * @return colour object, get hex string with hex property
 */
function getC(hue: number, shad: string): colourObj;
/**
 ...
 * @return colour object, get hex string with hex property
 */
function getC(hue: string, shad: string): colourObj;

function getC(arg1: string | number, arg2?: string | number): colourObj {
  let hue;
  let shad;
